...
class ComputeEventClassifier(BaseEventClassifier):
    ...
    def _initialize_rules(self):
        ...
        self.sensitive_read_only.update({
            ...
            ("ec2.amazonaws.com", "DescribeInstanceStatus"),               # Instance health and state - operational visibility
            ("ec2.amazonaws.com", "DescribeInstanceTypes"),                # Instance specs and capabilities - sizing info
            ...
            ("ec2.amazonaws.com", "DescribeVolumeStatus"),                 # Volume health and state - operational visibility
            ...
            ("ec2.amazonaws.com", "DescribeTags"),                         # Resource tags and metadata - asset inventory
            ("ec2.amazonaws.com", "DescribeCapacityReservations"),         # Reserved capacity details - cost planning
            ("ec2.amazonaws.com", "DescribePlacementGroups"),              # Placement group configuration - performance tuning
            ...
            ("ec2.amazonaws.com", "DescribeInstanceCreditSpecifications"), # Instance credit specs - cost optimization
            ("ec2.amazonaws.com", "DescribeReplaceRootVolumeTasks"),       # Root volume replacement tasks - system recovery
            ("ec2.amazonaws.com", "DescribeCapacityReservationBillingRequests"), # Billing requests - cost management
            ("ec2.amazonaws.com", "DescribeSpotInstanceRequests"),         # Spot instance requests - cost optimization
            ("ec2.amazonaws.com", "DescribeTransitGateways"),              # Transit gateway details - network architecture
            ("ec2.amazonaws.com", "GetCapacityReservationAccountAttribute"), # Account-level capacity attributes - quota info
            ...
            ("lambda.amazonaws.com", "GetFunctionRecursionConfig"),         # Recursion configuration - call limits
            ...
            ("lambda.amazonaws.com", "GetRuntimeManagementConfig"),         # Runtime management config - version control
            ...
            ("lambda.amazonaws.com", "ListProvisionedConcurrencyConfigs"),  # Provisioned concurrency - performance settings
            ("lambda.amazonaws.com", "ListTags20170331"),                   # Function tags - metadata and categorization
            ...
            ("lambda.amazonaws.com", "GetAccountSettings20160819"),         # Account-level Lambda settings - quotas
            ...
            ("ecs.amazonaws.com", "ListAccountSettings"),                   # ECS account settings - service quotas
        ...
        self.hacking_reads.update({
            ...
            ("ec2.amazonaws.com", "DescribeAddressTransfers"),              # Elastic IP transfer history - ownership tracking
            ("ec2.amazonaws.com", "DescribeAddressesAttribute"),            # Elastic IP attributes - metadata analysis
            ("ec2.amazonaws.com", "DescribeCapacityBlockExtensionHistory"), # Capacity block extensions - resource planning
            ("ec2.amazonaws.com", "DescribeEgressOnlyInternetGateways"),    # IPv6 egress-only gateways - network topology
            ("ec2.amazonaws.com", "DescribeReservedInstances"),             # Reserved instance details - cost optimization analysis
            ("ec2.amazonaws.com", "DescribeReservedInstancesModifications"), # Reserved instance modifications - cost changes
            ("ec2.amazonaws.com", "DescribeSpotFleetRequests"),             # Spot fleet requests - cost optimization patterns
            ...
            ("ec2.amazonaws.com", "DescribeVolumesModifications"),          # Volume modification history - storage changes
        ...
        self.strange_reads.update({
            ...
            ("ec2.amazonaws.com", "DescribeSpotPriceHistory"),              # Spot price history - cost analysis over time
            ("ec2.amazonaws.com", "DescribeReservedInstancesOfferings"),    # Reserved instance offerings - marketplace analysis
        })
